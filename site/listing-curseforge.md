...
Sleeping accelerates time — at a pace the server sets — instead of jumping to
...
in bed run the night at half speed. Nobody's sleep is wasted, nobody's insomnia vetoes the
...
3. Download Respite from this CurseForge page (via the CurseForge app or your
   launcher) and place it into `mods/` as well.
...
- **Modrinth:** <https://modrinth.com/mod/respite-vitality-overhaul>
