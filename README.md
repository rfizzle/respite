...
- **Continuous Time-Lapse** — sleeping accelerates time instead of skipping it.
  Each sleeper adds an equal share of the speed (up to 20× by default with
  everyone in bed), and the world genuinely runs through the compressed night: furnaces
