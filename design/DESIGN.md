...
- **Weariness effect icons** — a matched pair in Bone on transparent, matching vanilla effect-icon weight and framing: Weary is a half-lidded eye with a Moonlight iris still showing; Exhausted is the same eye pushed shut — a heavy closed lid, lashes hanging, a deeper eyebag, no iris. The open-vs-closed eye reads the two stages apart at a glance.
